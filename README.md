...
- 🔷 **Adaptive model selection** — automatically selects the optimal ML model class (Ridge, Random Forest, XGBoost, MLP, Stacking Ensemble) based on cohort size
- 🔷 **CV-R² diagnostics** — distinguishes true predictive generalization from rank-order preservation
- 🔷 **ML-gated GWAS** — concentrates statistical power on traits with evidence of genomic predictability

> 🧬 Supports **30–100,000+ samples** across any plant species · No Python required · Standalone binaries for Linux, macOS, CentOS
...
### 🌾 Wheat Pangenomics
Assembling and analyzing pangenomes of Montana winter, spring, and durum wheat varieties using **whole-genome resequencing**. Characterizing selective sweeps, genomic diversity, and functional gene expansion across elite North American germplasm.
...
### 🔗 Cross-Kingdom sRNA Regulation
Investigating **microRNA-mediated cross-kingdom gene silencing** between wheat and wheat stem sawfly (*Cephus cinctus*). Host-derived sRNAs as a novel mechanism of crop resistance.
...
**Genome Tools:** Flye · CANU · Verkko · GATK · STAR · DESeq2 · IQ-TREE · AlphaFold · PLINK · TASSEL
...
| Year | Journal | Title | Citations |
|------|---------|-------|-----------|
| 2024 | *J. Experimental Botany* | The chickpea WIP2 gene underlying a major QTL contributes to lateral root development | 9 |
| 2024 | *BMC Plant Biology* | Transcriptome-wide association mapping in rice bean (*V. umbellata*) | 5 |
| 2024 | *DNA Research* | DNA methylation landscapes in chickpea phenotypic diversity | 4 |
| 2023 | *BMC Biology* | Evolution of pathogenicity genes in *Rhizoctonia solani* AG1-IA | 22 |
| 2023 | *Crop Science* | Solid-stem wheat genetics for stem sawfly resistance | 8 |
| 2025 | *Elsevier (Book Ch.)* | Technological development for analyzing plant pangenomes | — |

> 📌 **Under Review:** Grapefruit chloroplast genomes (BMC Plant Biology) · GenoBridge ML pipeline (Plant Methods) · Durum wheat pangenome
...
[![Email TAMU](https://img.shields.io/badge/Email%20(TAMU)-nagendra.singh%40agnet.tamu.edu-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:nagendra.singh@agnet.tamu.edu)
...
[![GitHub](https://img.shields.io/badge/GitHub-nps--genomics-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nps-genomics)
